...
<div class="fieldcontain ${hasErrors(bean: tekEventInstance, field: 'startDate', 'error')} required">
	...
	<g:datePicker name="startDate" precision="day"  value="${tekEventInstance?.startDate}"  years="${2014..2020}" />
...
<div class="fieldcontain ${hasErrors(bean: tekEventInstance, field: 'endDate', 'error')} required">
	...
	<g:datePicker name="endDate" precision="day"  value="${tekEventInstance?.endDate}"  years="${2014..2020}"/>
...
<div class="fieldcontain ${hasErrors(bean: tekEventInstance, field: 'messages', 'error')} ">
	...
	<g:select name="messages" from="${com.tekdays.TekMessage.list()}" multiple="multiple" optionKey="id" size="5" value="${tekEventInstance?.messages*.id}" class="many-to-many"/>
